    ...
    <div class="w-full py-5">
      ...
      <div x-show="showCroppie">
          ...
          <div class="flex items-center justify-between py-2">
              ...
              <x-button primary class="" x-on:click="saveCroppie()">Done</x-button>
          </div>
      </div>

      <!--show result -->
      <div x-show="!showCroppie && hasImage" class="relative w-full h-full">
          <div class="mx-auto"><img src alt x-ref="result" class="mx-auto" style="height:auto; width:auto"></div>
          <div class="flex items-center justify-between py-2">
              <x-button primary class="" x-on:click="swap()">Swap</x-button>
              <x-button positive class="" x-on:click="edit()">Edit</x-button>
              <x-button positive class="" wire:click="$emit('{{ $saveFunc }}')">Save</x-button>
          </div>
      </div>
    </div>
  </div>
